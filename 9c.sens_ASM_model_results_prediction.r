...
fit_wts <- readRDS(paste0(folder_data_path, "outputs/sens_ASM_model_spline.rds"))
fit_unwt <- readRDS( paste0(folder_data_path, "outputs/sens_ASM_model_unwt_spline.rds"))
...
##set which model using for predict.
##stabilised weights####
fit_wts <- fit_wts
#summary(fit_wts)
...
saveRDS(results, paste0(folder_data_path, "outputs/sens_ASM_predictions_fitwts_spline.rds"))
# plot the results
...
saveRDS(wideres, paste0(folder_data_path,"outputs/sens_ASMpredict_surv_weighted.rds"))
